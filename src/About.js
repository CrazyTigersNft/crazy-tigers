      ...
      <Image className='headings' src={AboutTiger}/>
        <Flex justify='center' align='center' height='40vh' paddingBottom='150px'>
            <Box marginTop='250px' width='520px'>
                <div>
                    <Text className='about'>3333 Crazy Tigers live on Planet Panthera, it is under the threat of alien invasion. The Aliens abduct tigers putting them to work on their giant space stations. </Text>
                    <Text className='about'>Tigers live their lives as normal most of the time, working, having fun and making cubs ;). Sometimes they are recruited to go into space to fight off alien attacks. Their currency is $meat coin that they work to buy food - meat.</Text>
                </div>
            </Box>
        </Flex>
    </div>
